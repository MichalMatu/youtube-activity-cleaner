...
| Community posts ready state | `English` | Popup connects, shows ready state, settings preview loads |
| Community posts run and stop | `English` | Cleaner starts, counters move, stop works |
...
| Community posts ready state | `Polish` | Popup connects, shows localized ready state, settings preview loads |
| Community posts run and stop | `Polish` | Cleaner starts, counters move, stop works |
...
- Target page tested: comments, comment likes, live chat history, community posts, or liked videos
