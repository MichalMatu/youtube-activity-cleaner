...
Delete YouTube comments, comment likes, live chat history, community posts, and liked videos with a local-first cleaner.
...
2. If needed, use one of the popup shortcuts to open the comments, comment likes, live chat history, community posts, or liked videos page
...
- community posts cleaner: working
...
- The extension currently supports comments, comment likes, live chat history, community posts, and liked videos.
