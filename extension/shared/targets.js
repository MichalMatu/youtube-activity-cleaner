(() => {
  ...
  const targets = Object.freeze({
    ...
    liveChats: createMyActivityDeleteTarget({
      id: "liveChats",
      labelKey: "targetLiveChatsLabel",
      labelFallback: "Live chat history",
      enabled: true,
      pageUrl: "https://myactivity.google.com/page?page=youtube_live_chat",
      requiredUrlFragments: ["page=youtube_live_chat"],
      completedCountKey: "contentDeletedLiveChats",
      completedCountFallback: "Deleted live chat messages: $1",
      noMoreActionsKey: "contentNoMoreLiveChats",
      noMoreActionsFallback: "No more visible live-chat delete buttons were found.",
    }),
    communityPosts: createMyActivityDeleteTarget({
      id: "communityPosts",
      labelKey: "targetCommunityPostsLabel",
      ...
      noMoreActionsFallback: "No more visible community-post delete buttons were found.",
    }),
    likes: createTarget({
      id: "likes",
